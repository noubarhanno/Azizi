...
from Registration_Azizi.forms import RegistrationForm
from . import models
...
class CreateRegistration(CreateView):
    ...
    template_name='Registration_Azizi/index.html'

class IndexView(TemplateView):
    template_name='Registration_Azizi/Successful.html'
...
class RegistrationList(LoginRequiredMixin,ListView):
    ...
    # # template_name="Registration_Azizi/Registration_Details.html"
    # model=models.Registration
    template_name='Registration_Azizi/registration_list.html'
    context_object_name='RegistrationList'
